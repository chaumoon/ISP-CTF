...
Mở file, file yêu cầu nhập vào chuỗi số có 8 chữ số để check file
```
import hashlib
...
if __name__ == "__main__":
    main()
```
Do đó ta chạy 8 vòng for lồng nhau để check all trh
```
import hashlib
hashed_key = "b3d77ed0c460ef460792f07ad1e471d5fe70ac85c514e0b21b32e49d0f1b2c55"
hash_secret = 31580683746748870831459475506823890005573670692504809
...
if __name__ == "__main__":
    main()
```
Kết quả flag in ra là: ISPCTF{That_iS_Special_Number}
